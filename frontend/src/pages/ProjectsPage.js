  ...
  return (
    ...
    >
      ...
      {pendingFiles.length > 0 && (
        <div className="flex flex-wrap items-center gap-1.5 mt-3 mb-1" data-testid="project-embedding-status-bar">
          {pendingFiles.map((f, i) => {
            ...
            return (
              <span
                ...
                data-testid={`project-file-status-chip-${i}`}
              >
                {icon}
                ...
                {showRetry && (
                  <button
                    ...
                    data-testid={`project-retry-embedding-${i}`}
                  >
                    Retry
                  </button>
                )}
      ...
      <div className="flex gap-2 mt-3">
        ...
        <Button
          ...
          data-testid="project-attach-btn"
        >
